...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_configaratorId_fkey" FOREIGN KEY ("configaratorId") REFERENCES "Configarator"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
